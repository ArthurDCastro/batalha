    ...
    <div class="" style="margin: 25px 100px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?=base_url("/admin/edit_user?id={$_GET['id']}")?>" method="post">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control" id="atividade" name="atividade" placeholder="0 ou 1" value="<?=$user['atividade']?>">
                                </div>
                            </div>
