                ...
                <table class="table text-center">
                    ...
                    <?php foreach ($tb['confrontos'] as $conf): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" class="form-control mx-sm-1 text-center" name="tempo-<?= $conf['confronto'][0]['username'] ?>">
                            </td>
                            <td>x</td>
                            <td>
                                <input type="number" class="form-control mx-sm-1" name="tempo-<?= $conf['confronto'][0]['username'] ?>">
                            </td>
